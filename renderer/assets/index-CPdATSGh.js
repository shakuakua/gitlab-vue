...
const BASE = "https://gitlab.cn/api/v4";
async function getIssues(token, projectId) {
  const res = await axios.get(
    `${BASE}/projects/${projectId}/issues?state=opened`,
    { headers: { "PRIVATE-TOKEN": token } }
  );
  console.log(res);
  return res.data.map((iss) => ({
    id: iss.iid,
    title: iss.title,
    labels: iss.labels.slice(0, 3).map((l) => ({ name: l, color: randomColor() })),
...
const useKanbanStore = /* @__PURE__ */ defineStore("kanban", {
  state: () => ({
    issues: []
  }),
  actions: {
    async loadIssues(token, projectId) {
      this.issues = await getIssues(token, projectId);
      localStorage.setItem("issues", JSON.stringify(this.issues));
    },
    async moveIssue(issue, newState) {
...
const _hoisted_2$1 = { class: "labels" };
const _hoisted_3 = { class: "assignee" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$3, toDisplayString(__props.issue.title), 1),
        createBaseVNode("div", _hoisted_2$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.issue.labels, (l) => {
            return openBlock(), createElementBlock("span", {
              key: l.name,
              class: "label",
              style: normalizeStyle({ background: l.color })
            }, toDisplayString(l.name), 5);
          }), 128))
        ]),
        createBaseVNode("div", _hoisted_3, "👤 " + toDisplayString(__props.issue.assignee), 1)
      ], 32);
    };
  }
});
...
const IssueCard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b56e00ec"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        onDragenter: withModifiers(dragEnter, ["prevent"]),
        onDragleave: dragLeave
      }, [
        createBaseVNode("div", _hoisted_1$2, [
          createBaseVNode("span", null, toDisplayString(unref(colName)), 1),
          createBaseVNode("span", _hoisted_2, toDisplayString(__props.issues.length), 1)
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.issues, (i) => {
          return openBlock(), createBlock(IssueCard, {
            key: i.id,
            issue: i
          }, null, 8, ["issue"]);
        }), 128))
...
const Column = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4d4bbce1"]]);
const _hoisted_1$1 = { class: "board" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "KanbanBoard",
  setup(__props) {
    const store = useKanbanStore();
    const states = ["todo", "doing", "done"];
    function colIssues(state) {
      return store.issues.filter((i) => i.state === state);
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        (openBlock(), createElementBlock(Fragment, null, renderList(states, (s) => {
...
const KanbanBoard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b544ffd0"]]);
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          withDirectives(createBaseVNode("input", {
            ...
            type: "password",
            placeholder: "GitLab 私人令牌"
          }, null, 512), [
            [vModelText, token.value]
          ]),
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => projectId.value = $event),
            placeholder: "项目ID"
          }, null, 512), [
            [vModelText, projectId.value]
          ]),
          createBaseVNode("button", { onClick: loadBoard }, "加载看板"),
          createBaseVNode("button", { onClick: useMock }, "模拟数据")
        ]),
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f8e0e667"]]);
